...
make_query(model_name, model, tokenizer, 2, 'commonsenseQA', 'nucleus', 300, top_p=0.7)
make_query(model_name, model, tokenizer, 2, 'commonsenseQA', 'nucleus', 300, top_p=0.8)
make_query(model_name, model, tokenizer, 2, 'commonsenseQA', 'nucleus', 300, top_p=0.9)
make_query(model_name, model, tokenizer, 2, 'commonsenseQA', 'nucleus', 300, top_p=0.95)
make_query(model_name, model, tokenizer, 5, 'commonsenseQA', 'nucleus', 300, top_p=0.7)
make_query(model_name, model, tokenizer, 5, 'commonsenseQA', 'nucleus', 300, top_p=0.8)
make_query(model_name, model, tokenizer, 5, 'commonsenseQA', 'nucleus', 300, top_p=0.9)
make_query(model_name, model, tokenizer, 5, 'commonsenseQA', 'nucleus', 300, top_p=0.95)